...
```bash
git remote add encore encore://ai-chatbot-with-mcp-integration-vdy2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-chatbot-with-mcp-integration-vdy2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-chatbot-with-mcp-integration-vdy2/settings/integrations/github)
